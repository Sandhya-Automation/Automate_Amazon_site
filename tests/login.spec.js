...
test.describe.only("Login page- positive test cases", async() =>{
...
test.describe.skip("Login Page - Negative Test Cases", async() => {
    ...
    test('TC10 - Should handle very long email input', async({page})=>{
        const login = new LoginPage(page)
    ...
    test('TC14 - Should handle email with numeric domain', async({page})=>{
        const login = new LoginPage(page)
